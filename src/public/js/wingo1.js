...
function alertBox(join, addText) {
  ...
  switch (join) {
    case "x":
      selectCss("colorgreen", "#3c9cf6", addText);
      break;
    case "t":
    ...
    default:
      if (join % 2 == 0) {
        ...
        selectCss(`color${join}`, "#3c9cf6", addText);
      }
      break;
  }
  $(".van-overlay").fadeIn();
...
$(`.game-betting .box .item .img .van-image img`).attr('src', '/images/time-5d4e96a3.png');
$(`.game-betting .box .item:eq(${selectPageTime - 1}) .img .van-image img`).attr('src', '/images/time_a-f83ed4c7.png');